...
private fun VirtualFile.isAllowableFile(): Boolean {
    return !isInLocalFileSystem && fileType == ArchiveFileType.INSTANCE && extension == KLIB_FILE_EXTENSION // path to KLIB archive
            || isInLocalFileSystem && fileType == UnknownFileType.INSTANCE // path to local directory
}
